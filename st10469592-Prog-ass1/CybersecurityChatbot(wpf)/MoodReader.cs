...
{//start of namespace
    ...
    // enum for the possible moods detected in the user's message
    ...
    {//start of class
        ...
        // dictionary mapping each mood to its list of trigger words
        ...
        // CheckMood - scans the input and returns the first matching mood
        ...
        // MoodReply - returns an empathetic opening sentence for the detected mood
        // returns an empty string for None so nothing extra is added to the response
        ...
        // SetupMoodWords - fills the dictionary with trigger words for each mood
