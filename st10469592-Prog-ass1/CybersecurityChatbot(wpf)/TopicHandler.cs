...
{//start of namespace
    ...
    /// <summary>
    /// TopicHandler - manages all cybersecurity topic responses.
    /// Uses a Dictionary where each key is a topic word and the value
    /// is a List of full responses. FindAnswer() randomly selects one.
    /// </summary>
    ...
    {//start of class
        ...
        // FindAnswer - searches input for a known topic and returns a random response
        ...
        // FindKeyword - returns the matched topic word from the input
        ...
        // ListTopics - returns all topic keys for the help listing
        ...
        // RandomTip - picks a completely random tip from any topic
        // used when a mood is detected but no specific topic was mentioned
        ...
        // BuildAnswers - fills the dictionary with all topics and their response lists
        ...
        {//start of BuildAnswers
            ...
            // aliases so the user can say "2fa" or "authentication" and still match
